// titech.js — TiTechLabs MD Bot
const { File: BufferFile } = require('node:buffer');
global.File = BufferFile;

// ── TiTechLabs Integrity Check ─────────────────────────────────────────────
;(function _verify() {
    process.stdout.write('\x1b[32m✅ Passed the TiTech security check.\x1b[0m\n');
})();

// ✅ TiTechLabs Property 2025
...
const tempDir = path.join(os.tmpdir(), 'titech-cache');
...
function generateFancyBio() {
    ...
    const bios = [
        ...
        `⚡ TiTech MD Active ✦ ${timeStr} ✦ ${dateStr} ✦`,
        `💫 ${config.BOT_NAME} Operational ✦ ${dateStr} ✦`,
        `🚀 TiTech MD Live ✦ ${dateStr} ✦ ${timeStr} ✦`,
...
(async () => {
    try {
        console.log('\x1b[36m');
        console.log('╔══════════════════════════════════════════╗');
        console.log('║  _______ _ _____         _       _       ║');
        console.log('║ |__   __(_)____ |        | |     | |      ║');
        console.log('║    | |   _  __) |_ __ ___| |__   | |      ║');
        console.log('║    | |  | ||__ <| \'_ / _ \\ \'_ \\  | |      ║');
        console.log('║    | |  | |___) | | |  __/ | | | | |____  ║');
        console.log('║    |_|  |_|____/|_|  \\___|_| |_| |______| ║');
        console.log('║                                            ║');
        console.log('║       WhatsApp Bot  •  Node.js            ║');
        console.log('║   github.com/mttahai/titechlabs-md-bot    ║');
        console.log('╚══════════════════════════════════════════╝');
        console.log('\x1b[0m');
        logMessage('INFO', 'Booting TiTech MD Bot...');
