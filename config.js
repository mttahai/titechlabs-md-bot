...
module.exports = {
    ...
    BOT_NAME:              process.env.BOT_NAME || " 𝚃𝚒𝚃𝚎𝚌𝚑 MD ◔_◔",
    OWNER_NUMBER:          process.env.OWNER_NUMBER || "923429115114",
    OWNER_NAME:            process.env.OWNER_NAME || "𝐌.𝐓𝐚𝐡𝐚",
    DESCRIPTION:           process.env.DESCRIPTION || "𝚃𝚒𝚃𝚎𝚌𝚑𝙻𝚊𝚋𝚜 MD Bot",
    ALIVE_IMG:             process.env.ALIVE_IMG || "https://files.catbox.moe/u7zbat.jpeg",
    LIVE_MSG:              process.env.LIVE_MSG || "TiTech MD is active",
    ...
    AUTO_STATUS_MSG:       process.env.AUTO_STATUS_MSG || "Seen by TiTech MD",
    ...
    STATUS_MSG:            process.env.STATUS_MSG    || 'TiTech MD 💖 SUCCESSFULLY VIEWED YOUR STATUS',
